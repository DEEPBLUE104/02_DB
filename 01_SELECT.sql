...
--[작성법]
--WHERE 컬럼명 LIKE '패턴이 적용된 값'; ''표시는 문자 표시
...
-- EMPLOYEE 테이블에서 EMAIL에 _앞의 글자가 세글자인 사원만
-- 이름, 이메일 조회
...
SELECT EMP_ID, EMP_NAME, EMAIL, DEPT_CODE, 
HIRE_DATE, SALARY FROM EMPLOYEE
