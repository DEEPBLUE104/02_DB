...
-- 윈도우 > 설정 > 연결유형 Auto commit by default 체크 해제 되어있는지 다시 확인
...
'01088379985', 'D1', 'J7', 'S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N');
...
UPDATE DEPARTMENT2 
SET DEPT_ID = 'D0',
DEPT_TITLE = '전략기획팀' -- WHERE절 직전 컬럼에선 콤마(,) X
WHERE DEPT_ID ='D9'
AND DEPT_TITLE = '총무부';
...
'01012111155', 'D9', 'J4', 'S1', 9000000,  0.5, NULL, SYSDATE, NULL, 'N');
